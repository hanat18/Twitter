...
-When trying to edit one part of the layout but changing the whole screen and having to re-adjust everything 
-Implementing Cardview
-Using the 'like' and 'retweet' buttons
-trying to get the images from the posts to show up on the screen
-infinite pagination
